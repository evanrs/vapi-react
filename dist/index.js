...
const Vi = (e, t, n, r = "session") => {
  ...
  const [p] = le(
    () => e ? new Ni(e, n) : null
  ), [f, w] = le(!1), [k, A] = le(!1), [x, T] = le(!1), [M, R] = le(0), [_, y] = le("disconnected"), z = Ve({
    onCallStart: o,
    onCallEnd: c,
    onMessage: s,
    onError: u,
...
function qi(e, t) {
  ...
  return new Promise((h, p) => {
    ...
    let A = $i, x = 0;
    function T() {
      document.removeEventListener("visibilitychange", k), window.clearTimeout(x), w.abort();
    }
      ...
      try {
        ...
        if (!w.signal.aborted)
          try {
            ...
            window.clearTimeout(x), x = window.setTimeout(_, L);
          } catch (L) {
            T(), p(L);
          }
      }
...
const Qi = (e, t, n, r, i) => {
  ...
  const [s, u] = le(() => e && a ? [
    ...
    l
  ), x = Ve(null), T = Ve(null), M = Ve(""), R = Ve(null), _ = Ve(!1);
  Te(() => (t && e && (x.current = new Yi({ publicKey: t, apiUrl: i })), () => {
    T.current?.();
  }), [t, i, e]), Te(() => {
    l && A(l);
  }, [l]);
  const y = me(
    ...
    async (B, j = !1) => {
      try {
        ...
        const E = await x.current.streamChat(
          {
            input: S,
            assistantId: n,
            assistantOverrides: r,
  ...
  const [w, k] = le(null), [A, x] = le(!1), [T, M] = le([]), R = () => {
    if (r)
      return r;
    if (n)
      return i ? {
    ...
    reconnectStorageKey: s,
    onCallStart: () => {
      e === "hybrid" && (L.clearMessages(), M([])), k("voice"), x(!1), u?.();
    },
    onCallEnd: () => {
      k(null), h?.();
    },
    ...
    async ({ force: D } = {}) => {
      e === "hybrid" && !y.isCallActive && (L.clearMessages(), M([]), k("voice"), x(!1)), await y.toggleCall({ force: D });
    },
    [e, y, L]
  ), q = me(() => {
    M([]), L.clearMessages(), k(null), x(!1);
  ...
  const [k, A] = le(0), x = n, T = x ? 5 : h, R = l ? {
    animationType: "pulse",
    colors: "#EF4444",
    // Red for errors
    animationSpeed: 300
  ...
  }, S = x ? 2.8 : L * p, E = x ? 12 : L * f, D = S / 2, X = x ? F() : j;
  return /* @__PURE__ */ v(
    "div",
    {
...
`, s = "/", u = "*", h = "", p = "comment", f = "declaration";
  function w(A, x) {
    ...
    function y(S) {
      this.start = S, this.end = { line: T, column: M }, this.source = x.source;
    }
    ...
    function z(S) {
      ...
      if (E.reason = S, E.filename = x.source, E.line = T, E.column = M, E.source = A, !x.silent) throw E;
    }
    function L(S) {
      var E = S.exec(A);
      if (E) {
...
function Aa(e) {
  ...
  function k(M) {
    if (M === null) {
      A(e.exit("chunkFlow"), !0), x(0), e.consume(M);
      return;
    }
...
function Xa(e, t) {
  ...
  for (a.events = [], f ? (f._tokenizer = void 0, f.previous = void 0) : A.pop(), p = A.length; p--; ) {
    const x = o.slice(A[p], A[p + 1]), T = l.pop();
    c.push([T, T + x.length - 1]), e.splice(T, 2, x);
  }
...
function Jr(e, t, n, r, i, l, a, o, c) {
  ...
  return h;
  function h(x) {
    return x === 60 ? (e.enter(r), e.enter(i), e.enter(l), e.consume(x), e.exit(l), p) : x === null || x === 32 || x === 41 || nn(x) ? n(x) : (e.enter(r), e.enter(a), e.enter(o), e.enter("chunkString", {
      contentType: "string"
    }), k(x));
  }
  function p(x) {
    return x === 62 ? (e.enter(l), e.consume(x), e.exit(l), e.exit(i), e.exit(r), t) : (e.enter(o), e.enter("chunkString", {
      contentType: "string"
    }), f(x));
  }
  function f(x) {
    return x === 62 ? (e.exit("chunkString"), e.exit(o), p(x)) : x === null || x === 60 || H(x) ? n(x) : (e.consume(x), x === 92 ? w : f);
  }
  function w(x) {
    return x === 60 || x === 62 || x === 92 ? (e.consume(x), f) : f(x);
  }
  function k(x) {
    return !u && (x === null || x === 41 || ge(x)) ? (e.exit("chunkString"), e.exit(o), e.exit(a), e.exit(r), t(x)) : u < s && x === 40 ? (e.consume(x), u++, k) : x === 41 ? (e.consume(x), u--, k) : x === null || x === 32 || x === 40 || nn(x) ? n(x) : (e.consume(x), x === 92 ? A : k);
  }
  function A(x) {
...
function mo(e, t, n) {
  ...
  function A(d) {
    if (d === null || d === 47 || d === 62 || ge(d)) {
      ...
      return !J && !l && ir.includes(ae) ? (i = 1, r.interrupt ? t(d) : P(d)) : uo.includes(a.toLowerCase()) ? (i = 6, J ? (e.consume(d), x) : r.interrupt ? t(d) : P(d)) : (i = 7, r.interrupt && !r.parser.lazy[r.now().line] ? n(d) : l ? T(d) : M(d));
    }
...
function bo(e, t, n) {
  ...
  function A(m) {
    return m === 93 ? (e.consume(m), x) : k(m);
  }
  function x(m) {
    return m === 62 ? D(m) : m === 93 ? (e.consume(m), x) : k(m);
  }
  function T(m) {
...
function gs(e) {
  ...
  function r(b) {
    ...
    let K = -1;
    for (; ++K < b.length; )
      if (b[K][1].type === "listOrdered" || b[K][1].type === "listUnordered")
        if (b[K][0] === "enter")
          $.push(K);
        else {
          const he = $.pop();
    ...
    for (K = -1; ++K < b.length; ) {
      const he = t[b[K][0]];
      ti.call(he, b[K][1].type) && he[b[K][1].type].call(Object.assign({
        sliceSerialize: b[K][2].sliceSerialize
      }, O), b[K][1]);
    }
    ...
    for (I.position = {
      start: De(b.length > 0 ? b[0][1].start : {
        line: 1,
        column: 1,
        offset: 0
      }),
      end: De(b.length > 0 ? b[b.length - 2][1].end : {
        line: 1,
        column: 1,
        offset: 0
      })
    ...
    for (; ++$ <= O; ) {
      ...
      if (!K && fe[0] === "enter" && fe[1].type === "listItemPrefix" || K === -1 && fe[0] === "exit" && (fe[1].type === "listUnordered" || fe[1].type === "listOrdered")) {
        if (Fe) {
          ...
          for (Ee = void 0; Ne--; ) {
            ...
            if (Se[1].type === "lineEnding" || Se[1].type === "lineEndingBlank") {
              ...
              Ee && (b[Ee][1].type = "lineEndingBlank", he = !0), Se[1].type = "lineEnding", Ee = Ne;
          ...
          _e && (!Ee || _e < Ee) && (Fe._spread = !0), Fe.end = Object.assign({}, Ee ? b[Ee][1].start : fe[1].end), b.splice(Ee || $, 0, ["exit", Fe, fe[2]]), $++, O++;
        }
        if (fe[1].type === "listItemPrefix") {
          ...
          Fe = Ne, b.splice($, 0, ["enter", Ne, fe[2]]), $++, O++, _e = void 0, Pe = !0;
        }
      }
    }
    return b[I][1]._spread = he, O;
  }
  function l(b, I) {
    return O;
    function O($) {
      o.call(this, b($), $), I && I.call(this, $);
    }
  }
  function a() {
    this.stack.push({
  ...
  function o(b, I, O) {
    this.stack[this.stack.length - 1].children.push(b), this.stack.push(b), this.tokenStack.push([I, O || void 0]), b.position = {
      start: De(I.start),
  ...
  function s(b, I) {
    ...
    if ($)
      $[0].type !== b.type && (I ? I.call(this, b, $[0]) : ($[1] || or).call(this, b, $[0]));
    else throw new Error("Cannot close `" + b.type + "` (" + lt({
      start: b.start,
      end: b.end
    }) + "): it’s not open");
    O.position.end = De(b.end);
  }
  function u() {
  ...
  function T(b) {
    ...
    O.label = I, O.identifier = Xe(this.sliceSerialize(b)).toLowerCase();
  }
  function M() {
    const b = this.resume(), I = this.stack[this.stack.length - 1];
    I.title = b;
  ...
  function j(b) {
    ...
    I.value += this.sliceSerialize(b), I.position.end = De(b.end);
  }
  function F(b) {
    const I = this.stack[this.stack.length - 1];
    if (this.data.atHardBreak) {
      const O = I.children[I.children.length - 1];
      O.position.end = De(b.end), this.data.atHardBreak = void 0;
      return;
    }
    !this.data.setextHeadingSlurpLineEnding && t.canContainEols.includes(I.type) && (B.call(this, b), j.call(this, b));
  }
  function P() {
  ...
  function U(b) {
    const I = this.sliceSerialize(b), O = this.stack[this.stack.length - 2];
    O.label = ps(I), O.identifier = Xe(I).toLowerCase();
  }
  function W() {
    const b = this.stack[this.stack.length - 1], I = this.resume(), O = this.stack[this.stack.length - 1];
  ...
  function J(b) {
    const I = this.resume(), O = this.stack[this.stack.length - 1];
    O.label = I, O.identifier = Xe(this.sliceSerialize(b)).toLowerCase(), this.data.referenceType = "full";
  }
  function ae(b) {
    this.data.characterReferenceType = b.type;
  }
  function Q(b) {
    const I = this.sliceSerialize(b), O = this.data.characterReferenceType;
    let $;
  ...
  function o(c, s, u) {
    ...
    function p() {
      ...
      if ("children" in c && c.children) {
        ...
        if (x.children && f[0] !== iu)
          for (k = (r ? x.children.length : -1) + a, A = u.concat(x); k > -1 && k < x.children.length; ) {
            const T = x.children[k];
            if (w = o(T, k, A)(), w[0] === dr)
              return w;
...
function su(e, t) {
  ...
  function c(u, h) {
    ...
    if (o.options.passThrough && o.options.passThrough.includes(p)) {
      if ("children" in u) {
        const { children: k, ...A } = u, x = St(A);
        return x.children = o.all(u), x;
      }
      return St(u);
    }
...
function du() {
  ...
  return jt = function c() {
    var s, u, h, p, f, w, k = arguments[0], A = 1, x = arguments.length, T = !1;
    for (typeof k == "boolean" && (T = k, k = arguments[1] || {}, A = 2), (k == null || typeof k != "object" && typeof k != "function") && (k = {}); A < x; ++A)
...
const Zu = ({
  ...
  const Qe = "vapi_widget_expanded", [je, mt] = le(() => {
  ...
  }), [Ft, Ge] = le(!1), [Ze, Re] = le(""), [Ue, b] = le(!1), I = Ve(null), O = Ve(null), $ = me(
    (oe) => {
      mt(oe);
      try {
    ...
    [Qe]
  ), K = o ?? c, he = h ?? p, Fe = f ?? "#14B8A6", Ee = k ?? w ?? "#000000", _e = x ?? A ?? "#FFFFFF", Pe = T ?? M ?? "Talk with AI", fe = y ?? Pe, Ne = z, Se = R ?? "Start", fi = _ ?? "End Call", Mn = L ?? B, Tn = j ?? F, Ln = P ?? q, Fn = S ?? E, pi = D ?? U, Pt = m ?? N, zt = ae ?? Q, di = ce, mi = ie ?? ke, Nt = xe ?? ve, gi = Oe ?? ht, yi = Lt ?? ft, Pn = W ?? "Type your message...", xi = X ?? "This chat has ended. Thank you.", V = ll({
    mode: s,
    publicKey: e,
    assistantId: t,
    assistant: n,
  ...
  const Ei = () => {
    ...
    V.clearConversation(), b(!1), V.voice.isCallActive && V.voice.endCall({ force: Y }), Re(""), (s === "chat" || s === "hybrid") && setTimeout(() => {
      O.current?.focus();
    }, 100);
  }, Ii = async () => {
    try {
      await V.chat.sendMessage("Ending chat...", !0), b(!0);
    } finally {
      Re("");
    }
  }, Mi = () => {
    V.clearConversation(), b(!1), (s === "chat" || s === "hybrid") && setTimeout(() => {
      O.current?.focus();
    }, 100);
  }, Dn = () => {
    Ue && (V.clearConversation(), b(!1), Re("")), $(!1);
  }, Ti = () => {
    $(!0);
