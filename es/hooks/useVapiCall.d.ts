...
export declare const useVapiCall: ({ publicKey, callOptions, apiUrl, enabled, voiceAutoReconnect, voiceReconnectStorage, reconnectStorageKey, onCallStart, onCallEnd, onMessage, onError, onTranscript, }: UseVapiCallOptions) => VapiCallState & VapiCallHandlers & VapiCallInstance;
